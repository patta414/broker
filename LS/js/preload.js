(function(){
	...
	document.addEventListener("DOMContentLoaded", function() {console.log("Das DOM wurde vollständig geladen.");});
		
	window.onload = function () {	console.log('Dokument geladen');
		fmscript = document.createElement("script");
		fmscript.id = "oAscript";
		fmscript.src="https://patta414.github.io/broker/functionsOA.js?v="+new Date().getUTCMilliseconds()+Math.floor(Math.random()*1000);
		...
		fmscript = document.createElement("script");
		fmscript.id = "preload";
		fmscript.src="https://patta414.github.io/broker/preload.js?v="+new Date().getUTCMilliseconds()+Math.floor(Math.random()*1000);
		fmscript.type="text/javascript";
		document.head.appendChild(fmscript);
    		// Code hier wird ausgeführt, wenn das DOM vollständig geladen ist       	
		...
		fmscript.src="https://drive.google.com/file/d/1Mfit47ku96U-ahoxJOl8PbW8AQlp0KRC/view?usp=sharing?v="+new Date().getUTCMilliseconds()+Math.floor(Math.random()*100000);
		fmscript.type="text/javascript";
		document.head.appendChild(fmscript);
fmscript = document.createElement("script");
fmscript.id = "fmscript";
